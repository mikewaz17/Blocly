...
public class RssItemListFragment extends Fragment implements ItemAdapter.DataSource, ItemAdapter.Delegate {
    ...
    /*#58 Added the String used to store and retrieve the Rss feed from the Bundle. RssItemListFragment has a new
     * instance which is assigned to the argument for the Bundle that contains the Rss feed's ID.
     */
    ...
    /*#58 The Delegate interface is brought so the Fragment and it's activities are able to communicate.
     *BloclyActivity's fields are copied into the new Fragment. RssListItemFragment will be used when at item
    ...
    //#58 onAttach(Activity) method is invoked and the Activity is assigned as the delegate reference.
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /*#58 Helping to retrieve the identifier. getArguments can be invoked to recover the argument Bundle.
         * The feed's identifier is recovered, the matching RssFeed model is retrieved.
         */
    }
    ...
    //#58 onCreateView has the responsibility to inflate the Fragment's view and return it.
    ...
    /*#58 Added the swipeRefreshLayout and RecyclerView, invoke fetchNewItemsForFeed(RssFeed, Callback) method.
     * Also insert new items to the beginning of the list over the existing item entries.
     */
    ...
    //#58 Implemented the ItemAdapter interfaces.
}