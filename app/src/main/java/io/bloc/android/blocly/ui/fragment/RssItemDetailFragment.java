...
/*#59 The Fragment method helps other classes with a copy of RssItemDetailFragment. Uses the
 * String key to pass it into the Fragment. onCreate method recovers and fetches the RssItem model.
 * RssItemDetailFragment loads the item's image and implements the ImageLoadingListener, which allows
 * the ProgressBar to appear
 */
